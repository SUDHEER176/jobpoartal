    ...
    return (
        <div className="min-h-screen bg-white dark:bg-black overflow-x-hidden">
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
                ...
                {/* Gradient Orbs */}
                <div className="absolute top-20 right-10 w-[500px] h-[500px] bg-blue-600/20 rounded-full blur-[120px] animate-pulse" />
                <div className="absolute bottom-20 left-10 w-[600px] h-[600px] bg-indigo-600/10 rounded-full blur-[140px] animate-pulse" />
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <FlowButton
                                ...
                                className="!bg-white !text-blue-900 border-none shadow-2xl shadow-blue-500/30"
                            />
                            <FlowButton
                                text="Sign Up Free"
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className="bg-white dark:bg-black/40 backdrop-blur-md rounded-3xl p-8 border border-slate-200 dark:border-white/10 hover:shadow-xl hover:shadow-blue-500/5 transition-all group"
                            >
