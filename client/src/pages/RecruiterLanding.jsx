    ...
    return (
        <div className="min-h-screen bg-white dark:bg-black overflow-x-hidden">
            ...
            <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
                ...
                <div className="absolute bottom-20 right-10 w-[600px] h-[600px] bg-indigo-600/10 rounded-full blur-[140px] animate-pulse" />
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 py-20 grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                            <FlowButton
                                ...
                                className="!bg-white !text-purple-900 border-none shadow-2xl shadow-purple-500/30"
                            />
                            <FlowButton
                                text="Sign Up Free"
                                onClick={() => navigate('/auth?mode=signup&role=recruiter')}
                    ...
                    >
                        <div className="relative">
                            {/* Main Dashboard Card */}
                            <div className="bg-white/10 dark:bg-black/60 backdrop-blur-xl rounded-3xl border border-white/20 p-6 shadow-2xl">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className="bg-white dark:bg-black/40 backdrop-blur-md rounded-3xl p-8 border border-slate-200 dark:border-white/10 hover:shadow-xl hover:shadow-purple-500/5 transition-all group"
                            >
            ...
            {/* Trust & Credibility */}
            <section className="py-24 bg-slate-50 dark:bg-black border-y dark:border-white/5">
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="bg-white dark:bg-black/60 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-slate-200 dark:border-white/10 shadow-xl text-center">
